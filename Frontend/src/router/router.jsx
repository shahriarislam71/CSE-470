...
<<<<<<< HEAD
  {
    ...
    children: [
      ...
      // Course Materials - make this a parent route
      {
        path: "materials",
        element: <CourseMaterials />,
        children: [
          { index: true, element: <Navigate to="videos" replace /> }, // Default to videos
          { path: "videos", element: <CourseVideos /> },
          { path: "notes", element: <CourseNotes /> },
          { path: "practice", element: <CoursePractice /> },
        ],
      },
