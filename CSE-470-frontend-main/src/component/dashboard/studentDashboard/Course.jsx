    ...
    useEffect(() => {
        setCourses([
            ...
            },
            {
                id: 2,
                courseImage:
                    "https://static.vecteezy.com/system/resources/thumbnails/005/442/693/small/data-science-analytics-internet-and-technology-concept-concept-photo.jpg",
                    ...
                    <div className="bg-white ml-[300px] max-w-4xl w-full rounded-lg shadow-lg overflow-hidden max-h-full overflow-y-auto">
                        ...
                        >
                            <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-white text-center p-6">
                                ...
                                <p className="text-md mt-1">
                                    ...
                                    ({selectedCourse.instructorInitial})
                                </p>
                            </div>
                            <button
                        ...
                        <div className="p-6">
                            ...
                            <ul className="list-disc list-inside mt-2 text-[#012d5b]">
                                {selectedCourse.courseOutline.map(
                                    (item, index) => (
                            ...
                            {/* Course Outcome */}
                            <h3 className="text-xl font-bold text-[#A855F7] mt-6">
                                Course Outcome
                            </h3>
                            <ul className="list-disc list-inside mt-2 text-[#012d5b]">
                                {selectedCourse.courseOutcome.map(
                                    (item, index) => (
                                        <li key={index}>{item}</li>
                                    )
                                )}
            ...
            {showEmailModal && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center p-4">
                    <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                        <h2 className="text-xl font-bold text-[#A855F7] mb-4">
                            Enter Your Email
                        </h2>
                        <input
                            type="email"
